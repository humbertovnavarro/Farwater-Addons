...
public class HyperRaccoonTokenBoss extends Animal implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

    public HyperRaccoonTokenBoss(EntityType<? extends Animal> pEntityType, Level pLevel) {

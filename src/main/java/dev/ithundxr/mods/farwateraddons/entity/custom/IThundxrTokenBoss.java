...
public class IThundxrTokenBoss extends Animal implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

    public IThundxrTokenBoss(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public static boolean canSpawn(EntityType<IThundxrTokenBoss> entityType, LevelAccessor levelAccessor, MobSpawnType spawnType, BlockPos pos, Random random) {
